...
class DrinkInfo2 extends StatefulWidget {
  const DrinkInfo2({Key? key}) : super(key: key);

  @override
  State<DrinkInfo2> createState() => _DrinkInfo2State();
}

class _DrinkInfo2State extends State<DrinkInfo2> {
  var c1 = Color.fromARGB(195, 219, 96, 96);
  var changColor = Color.fromARGB(255, 80, 143, 151);
