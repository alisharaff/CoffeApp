...
List<String> list2=<String>['Arabica','Robusta','Liberica',"Excelsa"];
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
        ...
        decoration: BoxDecoration(
                  color: Color.fromARGB(255, 202, 66, 66),
         ...
         child: TextButton(
          ...
          AwesomeDialog(
                      ...
                      body: Column(children: [
                        Text( 'Choose what you like',style: TextStyle(fontSize: 25.0),),
                        ListTile(
                          title: Text("Sugar"),
                          subtitle: Text("How many spoons of sugar ? "),
                          trailing: Container(
                            width: 100.0,
                            height: 150,
                        ...
                        ListTile(
                          title: Text("Coffee"),
                          subtitle: Text("Your type of coffee ?"),
                          trailing: Container(
                            width: 100.0,
                            height: 150,
                            child: DropdownButton(
                        ...
                        ListTile(
                          title: Text("Ice"),
                          subtitle: Text("How many pieces of ice ?"),
                          trailing: Container(
                            width: 100.0,
                            height: 150,
                            child: DropdownButton(
